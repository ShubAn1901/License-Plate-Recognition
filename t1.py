...
class RPLicence(nn.Module):
    ...
    # written for on
        ...
        out4=self.hid42(func.dropout(func.relu(self.hid41(func.Dropout(_rois,training=self.training)))))
        out5=self.hid52(func.dropout(func.relu(self.hid51(func.Dropout(_rois,training=self.training)))))
        out6=self.hid62(func.dropout(func.relu(self.hid61(func.Dropout(_rois,training=self.training)))))
        out7=self.hid72(func.dropout(func.relu(self.hid71(func.Dropout(_rois,training=self.training)))))
